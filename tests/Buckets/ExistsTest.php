...
use JaegerApp\Validate\Rules\Gcs\Buckets\Exists;
...
class ExistsTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRuleFail()
    {
        ...
        $val->rule('gcs_bucket_exists', 'connection_field', $creds)->val(array(
    ...
    {
        $val = new Validate();
        $val->rule('gcs_bucket_exists', 'connection_field', $this->getGcsCreds())
            ->val(array(
